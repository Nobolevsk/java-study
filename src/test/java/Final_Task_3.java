...
//
//Например, 1000 российских рублей соответствуют 19,40 долларам США. Допустим, рубль выбран в качестве базовой валюты и указана кратность курса доллара 100. Выполняем расчет:
//
